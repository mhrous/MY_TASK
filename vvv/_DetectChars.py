...
def detectCharsInPlates(listOfPossiblePlates):
    ...
    for possiblePlate in listOfPossiblePlates:
        ...
        possiblePlate.imgGrayscale, possiblePlate.imgThresh = _Preprocess.preprocess(possiblePlate.imgPlate)
...
def findPossibleCharsInPlate(imgThresh):
    ...
    for contour in contours:
        possibleChar = _PossibleChar.PossibleChar(contour)
...
def checkIfPossibleChar(possibleChar):
    return (
            ...
            and possibleChar.intBoundingRectHeight > MIN_PIXEL_HEIGHT and
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:
        ...
        cv2.rectangle(imgThreshColor, pt1, pt2, _Main.SCALAR_GREEN, 2)
